...
svm_classifier.fit(final_training_dataset_keys, final_training_dataset_values)
end_time = time.time() - start_time
...
svm_classifier_accuracy = svm_classifier.score(final_testing_dataset_keys, final_testing_dataset_values)
...
print "-------------------------------------------------"
print "Standard LinearSVM accuracy : "+ str(svm_classifier_accuracy)
